...
import engine, IntArt, time, os
import tkinter

width = height = 729
dimension = 9 #Dimensión del tablero.
sq_Size = 729 // dimension #Dimensiones de las casillas.
max_fps = 15 #Para las animaciones.
images = {}
icon = p.image.load("images/Ritsu.jpg")
p.display.set_icon(icon)
p.display.set_caption("Ritsu pyShogi")

"""
Para inicializar las imagenes de las piezas.
"""
def loadImage ():
    pieces = ['bP', 'bと', 'bR', 'b竜', 'bB', 'b馬', 'bL', 'b仝', 'bN', 'b今', 'bS', 'b銀', 'bQ', 'bK', 'wP', 'wと', 'wR', 'w竜', 'wB', 'w馬', 'wL', 'w仝', 'wN', 'w今', 'wS', 'w銀', 'wQ', 'wK']
    for piece in pieces:
